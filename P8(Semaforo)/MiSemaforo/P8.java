...
class Buffer {
	...
	final MySemaphore writer = new MySemaphore(0);//valor 0 para que empiece a escribir ya que no hay nada en productos
	final MySemaphore reader = new MySemaphore(1);//valor 1 para que no haga nada mientras no se escriba
	//sólo permite 1 valor, es decir no se puede escribir ni leer dos veces
